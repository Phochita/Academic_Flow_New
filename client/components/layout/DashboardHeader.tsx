    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#e7d8fb] bg-white/95 backdrop-blur">
      <div className="flex min-h-[70px] items-center justify-between gap-3 px-4 sm:px-5 lg:px-6 xl:px-7">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-full border-2 border-[#ff9d75] bg-[radial-gradient(circle_at_35%_28%,#fff2cf_0%,#f4dcb5_45%,#c79f74_100%)] text-[0.7rem] font-bold text-[#4a3427] shadow-[0_14px_24px_-20px_rgba(91,46,199,0.95)]">
            {initials}
          </div>
        </div>
      </div>
