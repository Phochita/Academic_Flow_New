...
function MaterialResourcePageContent() {
...
export default function MaterialResourcePage() {
  return (
    <Suspense fallback={<div className="mx-auto max-w-[980px] px-5 py-8 text-sm font-semibold text-[#6d38de]">Loading resource library...</div>}>
      <MaterialResourcePageContent />
    </Suspense>
  );
}
